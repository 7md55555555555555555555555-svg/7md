...
export const botConfig = {
  ...
  presence: {
    ...
    activities: [
      {
        name: "الشافعي", // required by Discord API, not shown in the client
        state: "فإن كانت الأيام خانت عهودنا فإني بها راضٍ ولكنها قهر",     // this is what people actually see
        type: 2,               // Custom
      },
    ],
  },
